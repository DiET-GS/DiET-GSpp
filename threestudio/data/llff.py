...
class LLFFDatasetBase():
    ...
    def read_intrinsics(self):
        ...
        h = -1 # int(camdata[1].height*self.downsample)
        w = -1 # int(camdata[1].width*self.downsample)
    ...
    def read_meta(self, split, **kwargs):
        ...
        PATH = "/data/sjlee/DiSR-NeRF/data/evdeblur_nerf/blurbatteries/images"
        img_paths = [os.path.join(PATH, img_path) for img_path in os.listdir(PATH) ]
        w2c_mats = []
        ...
        self.poses, self.pts3d = None, None # center_poses(poses, pts3d)
